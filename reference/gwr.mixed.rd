<!DOCTYPE html>
<!-- Generated by pkgdown: do not edit by hand --><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Mixed GWR — gwr.mixed • GWmodel</title><!-- jquery --><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js" integrity="sha512-v2CJ7UaYy4JwqLDIrZUI/4hqeoQieOmAZNXBeQyjo21dadnwR+8ZaIJVT8EE2iyI61OV8e6M8PP2/4hpQINQ/g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script><!-- Bootstrap --><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.4.1/css/bootstrap.min.css" integrity="sha256-bZLfwXAP04zRMK2BjiO8iu9pf4FbLqX6zitd+tIvLhE=" crossorigin="anonymous"><script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.4.1/js/bootstrap.min.js" integrity="sha256-nuL8/2cJ5NDSSwnKD8VqreErSWHtnEP9E7AySL+1ev4=" crossorigin="anonymous"></script><!-- bootstrap-toc --><link rel="stylesheet" href="../bootstrap-toc.css"><script src="../bootstrap-toc.js"></script><!-- Font Awesome icons --><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css" integrity="sha256-mmgLkCYLUQbXn0B1SRqzHar6dCnv9oZFPEC1g1cwlkk=" crossorigin="anonymous"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/v4-shims.min.css" integrity="sha256-wZjR52fzng1pJHwx4aV2AO3yyTOXrcDW7jBpJtTwVxw=" crossorigin="anonymous"><!-- clipboard.js --><script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.6/clipboard.min.js" integrity="sha256-inc5kl9MA1hkeYUt+EC3BhlIgyp/2jDIyBLS6k3UxPI=" crossorigin="anonymous"></script><!-- headroom.js --><script src="https://cdnjs.cloudflare.com/ajax/libs/headroom/0.11.0/headroom.min.js" integrity="sha256-AsUX4SJE1+yuDu5+mAVzJbuYNPHj/WroHuZ8Ir/CkE0=" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/headroom/0.11.0/jQuery.headroom.min.js" integrity="sha256-ZX/yNShbjqsohH1k95liqY9Gd8uOiE1S4vZc+9KQ1K4=" crossorigin="anonymous"></script><!-- pkgdown --><link href="../pkgdown.css" rel="stylesheet"><script src="../pkgdown.js"></script><meta property="og:title" content="Mixed GWR — gwr.mixed"><meta property="og:description" content="This function implements mixed (semiparametric) GWR"><!-- mathjax --><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js" integrity="sha256-nvJJv9wWKEm88qvoQl9ekL2J+k/RWIsaSScxxlsrv8k=" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/config/TeX-AMS-MML_HTMLorMML.js" integrity="sha256-84DKXVJXs0/F8OTMzX4UR909+jtl4G7SPypPavF+GfA=" crossorigin="anonymous"></script><!--[if lt IE 9]>
...
<![endif]--></head><body data-spy="scroll" data-target="#toc">
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>gwr.mixed.rd</code></div>
    </div>

    <div class="ref-description">
    <p>This function implements mixed (semiparametric) GWR</p>
    </div>

    <div id="ref-usage">
    <div class="sourceCode"><pre class="sourceCode r"><code><span><span class="fu">gwr.mixed</span><span class="op">(</span><span class="va">formula</span>, <span class="va">data</span>, <span class="va">regression.points</span>, <span class="va">fixed.vars</span>,</span>
<span>                     intercept.fixed<span class="op">=</span><span class="cn">FALSE</span>, <span class="va">bw</span>, diagnostic<span class="op">=</span><span class="cn">T</span>, kernel<span class="op">=</span><span class="st">"bisquare"</span>, </span>
<span>                     adaptive<span class="op">=</span><span class="cn">FALSE</span>, p<span class="op">=</span><span class="fl">2</span>, theta<span class="op">=</span><span class="fl">0</span>, longlat<span class="op">=</span><span class="cn">F</span>,<span class="va">dMat</span>, <span class="va">dMat.rp</span><span class="op">)</span></span></code></pre></div>
    </div>
...
<dd><p>a Spatial*DataFrame object, i.e. SpatialPointsDataFrame or SpatialPolygonsDataFrame as defined in package <span class="pkg">sp</span></p></dd>
  ...
  <dt id="arg-fixed-vars">fixed.vars<a class="anchor" aria-label="anchor" href="#arg-fixed-vars"></a></dt>
<dd><p>independent variables that appeared in the formula that are to be treated as global</p></dd>

  <dt id="arg-intercept-fixed">intercept.fixed<a class="anchor" aria-label="anchor" href="#arg-intercept-fixed"></a></dt>
<dd><p>logical, if TRUE the intercept will be treated as global</p></dd>
...
<dd><p>logical, if TRUE the diagnostics will be calculated</p></dd>
...
<dd><p>a pre-specified distance matrix, it can be calculated by the function <code><a href="gw.dist.html">gw.dist</a></code></p></dd>
  ...
  <dt id="arg-dmat-rp">dMat.rp<a class="anchor" aria-label="anchor" href="#arg-dmat-rp"></a></dt>
<dd><p>a distance matrix when an individual set of regression points are adopted</p></dd>

</dl></div>
    <div id="value">
    <h2>Value</h2>
    <p>A list of class “mgwr”:</p>
<dl><dt>GW.arguments</dt>
<dd><p>a list class object including the model fitting parameters for generating the report file</p></dd>

  <dt>aic</dt>
<dd><p>AICc value from this calibration</p></dd>

  <dt>df.used</dt>
<dd><p>effective degree of freedom</p></dd>

  <dt>rss</dt>
<dd><p>residual sum of squares</p></dd>
...
tests for geographically weighted regression. Journal of Regional Science 39(3):497-524</p>
<p>Mei L-M, He S-Y, Fang K-T (2004) A note on the mixed geographically weighted regression
model. Journal of regional science 44(1):143-157</p>
<p>Mei L-M, Wang N, Zhang W-X (2006) Testing the importance of the explanatory variables
in a mixed geographically weighted regression model. Environment and Planning A 38:587-598</p>
...
Statistics in Medicine 24: 2695-2717</p>
<p>Nakaya T et al. (2011) GWR4.0, <a href="http://gwr.nuim.ie/" class="external-link">http://gwr.nuim.ie/</a>.</p>
    </div>
    <div id="note">
    <h2>Note</h2>
...
This windows-based software also implements generalised mixed GWR.</p>
<p>The mixed GWR in the latest release of GWmodel (2.0-0) has been revised by Dr. Fiona H Evans from Centre for Digital Agriculture, Murdoch and Curtin Universities in terms of its computational efficiency.</p>
    </div>
    <div id="author">
    <h2>Author</h2>
